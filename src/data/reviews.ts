...
export const reviews: Review[] = [
  ...
  {
    id: nanoid(),
    slug: 'vacations-by-marriott-bonvoy',
    title: 'Vacations by Marriott Bonvoy',
    mainCategory: 'Market',
    ...
    pros: ['Hotel + flight package discovery', 'Marriott brand familiarity', 'Destination-led deals', 'Points-oriented booking path'],
    cons: ['Package value depends on dates and destination', 'Terms and cancellation rules need review', 'Separate booking may sometimes be cheaper'],
    specs: { 'Category': 'Travel packages', 'Best use': 'Hotel + flight vacation comparison', 'Loyalty angle': 'Marriott Bonvoy points on qualifying packages' },
    price: 'See current package pricing',
    contentSections: [],
    toxicDeepDive: 'Vacations by Marriott Bonvoy is best treated as a benchmark, not an automatic booking answer. The smart move is to price one real trip, compare the package total against separate bookings, and verify current points and cancellation rules before checkout.',
    targetAudience: ['Marriott loyalists', 'Families', 'Resort travelers', 'Deal-focused vacation shoppers']
  },
  {
    id: nanoid(),
    slug: 'shapellx',
    ...
    pros: ['Broad shapewear catalog', 'Support-level shopping cues', 'Bodysuits, swim, bras, activewear, and sale options', 'Fit-focused filters'],
    cons: ['Sizing requires careful measurement', 'Compression comfort varies by body and occasion', 'Return terms matter for intimate apparel and sale items'],
    specs: { 'Category': 'Shapewear and support apparel', 'Best use': 'Outfit-based smoothing and support', 'Shopping angle': 'Compression, control area, and size' },
    price: 'See current Shapellx pricing',
    contentSections: [],
    toxicDeepDive: 'Shapellx works best when treated like a fit system, not a magic before-and-after promise. The right purchase starts with a real outfit need, the correct support level, and a return policy check.',
    targetAudience: ['Event outfit shoppers', 'Shapewear buyers', 'Bodysuit shoppers', 'Comfort-first support shoppers']
  },
  {
    id: nanoid(),
    slug: 'norma-kamali',
    ...
    subCategory: 'Fashion',
    rating: 4.5,
    affiliateLink: 'https://normakamali.com/',
    ...
    pros: ['Distinctive silhouettes', 'Dresses, swim, bodysuits, and jersey', 'Modern travel-friendly wardrobe angle', 'Clear designer identity'],
    cons: ['Fit can be style-specific', 'Investment value depends on repeat wear', 'Care and return terms need attention'],
    specs: { 'Category': 'Designer fashion', 'Best use': 'Statement dressing and swim', 'Shopping angle': 'Silhouette, fabric, and occasion' },
    price: 'See current NORMA KAMALI pricing',
    contentSections: [],
    toxicDeepDive: 'NORMA KAMALI works best when treated as a silhouette purchase rather than a trend browse. The right item should have a real occasion and a repeatable styling life.',
    targetAudience: ['Event dress shoppers', 'Modern minimalists', 'Swim shoppers', 'Travel wardrobe builders']
  },
  {
    id: nanoid(),
    slug: 'dents-gloves',
    ...
    rating: 4.6,
    affiliateLink: 'https://www.dentsgloves.com/',
    ...
    pros: ['Heritage craft since 1777', 'Leather and lining variety', 'Touchscreen and driving options', 'Giftable accessories'],
    cons: ['Sizing requires measurement', 'Leather needs care', 'Warmth varies by lining and style'],
    specs: { 'Category': 'Leather accessories', 'Best use': 'Gloves, driving, commuting, and gifts', 'Shopping angle': 'Leather, lining, and fit' },
    price: 'See current Dents pricing',
    contentSections: [],
    toxicDeepDive: 'Dents is a material and fit purchase. The heritage story matters, but the pair only earns its place if the leather, lining, and use case match how you actually move through cold weather.',
    targetAudience: ['City commuters', 'Driving and travel shoppers', 'Gift buyers', 'Leather accessory collectors']
  },
  {
    id: nanoid(),
    ...
    pros: ['Broad category range', 'Bra and fit shopping paths', 'Beauty, sleep, swim, and activewear', 'Recognizable gift categories'],
    cons: ['Fit varies by style', 'Promotions can complicate value', 'Product-specific returns need review'],
    specs: { 'Category': 'Intimates and beauty', 'Best use': 'Bras, lingerie, sleep, beauty, and gifts', 'Shopping angle': 'Fit, fabric, collection, and value' },
    price: 'See current Victoria\'s Secret pricing',
    contentSections: [],
    toxicDeepDive: "Victoria's Secret is most useful as a category-and-fit shopping destination. The catalog is broad, so a real need is the best defense against promotion-led browsing.",
    targetAudience: ['Everyday essentials shoppers', 'Gift buyers', 'Lingerie shoppers', 'Beauty and self-care shoppers']
  },
  {
    id: nanoid(),
    slug: 'levis',
    ...
    pros: ['Classic denim identity', 'Broad fit and wash range', 'Recognizable wardrobe staples', 'Often compelling during sales'],
    cons: ['Sizing can vary by style and wash', 'Not always the most premium denim', 'Full-price value depends on fabric and construction'],
    specs: { 'Category': 'Denim and apparel', 'Best use': 'Jeans, trucker jackets, tees', 'Shopping angle': 'Fit, wash, and sale comparison' },
    price: 'See current Levi\'s pricing',
    contentSections: [],
    toxicDeepDive: "Levi's is not magic denim. It is a practical, familiar starting point. The win is finding a proven fit at a sensible price; the trap is buying a discounted wash or stretch blend that does not actually fit your wardrobe.",
    targetAudience: ['Everyday denim buyers', 'Casual wardrobe builders', 'Deal shoppers', 'Classic style shoppers']
  },
