...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    rating: 4.7,
    affiliateLink: 'https://www.linkhaitao.com/index.php?mod=lhdeal&track=0ff1BxKKZRQd_aBBd1sinqcY5oUlDSj56nRPFKyp0I_aTXU8LQAy5EWutW4EiJdGJdlkbGGUQN5ZMn7WzpqqIxRjx4z335ArdnfWjcpA_c_c&new=http%3A%2F%2Fwww.lecreuset.com',
    thumbnailUrl: withBasePath('/le-creuset-hero.jpg'),
    updatedAt: '2026-09-05',
    editorialVerdict: 'Le Creuset is strongest as a carefully chosen enameled cast-iron workhorse: excellent heat retention, durable color, and oven-to-table presentation at a premium price.',
    buyingAdvice: 'Start with the meals you cook, then choose material, shape, capacity, weight, and color. A useful Dutch oven or braiser is easier to justify than a decorative matching set.',
    pros: ['Excellent heat retention', 'No seasoning required', 'Broad color and shape selection', 'Cook-to-table presentation'],
    cons: ['Premium price', 'Heavy to lift and store', 'Enamel needs considerate handling'],
    specs: { 'Category': 'Premium cookware', 'Best use': 'Braising, stews, bread, roasting, and serving', 'Shopping angle': 'Material, shape, size, and color' },
    price: 'See current Le Creuset pricing',
    contentSections: [],
    toxicDeepDive: 'Le Creuset is easy to romanticize and expensive to collect. Its value is clearest when one well-chosen piece becomes a weekly workhorse, not when color launches turn cookware into shelf decoration.',
    targetAudience: ['Home cooks', 'Dutch oven buyers', 'Wedding and housewarming shoppers', 'Design-conscious kitchens']
  },
  {
    id: nanoid(),
    slug: 'levis',
