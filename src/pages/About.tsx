...
import trustSeal from "@/assets/trust_seal.jpg"; // Generated asset

export default function About() {
  return (
    <Layout>
      <SEO 
        title="About Us | DailyChoice"
        description="DailyChoice is a team of obsessively curious editors dedicated to finding the tools and gear that actually improve your life."
      />
      <div className="relative h-[400px] w-full overflow-hidden">
        <img 
          src={aboutTeam} 
          alt="DailyChoice Team Office" 
      ...
      <TextPageLayout title="Our Mission" className="mt-[-80px] relative z-10 bg-background p-8 rounded-t-3xl shadow-xl">
        <p className="lead">
          ...
          DailyChoice exists to cut through the noise. We are a team of obsessively curious editors, 
        ...
        <h2>Our Story</h2>
        <p>
          Founded in 2024, DailyChoice started with a simple spreadsheet comparing coffee makers. 
