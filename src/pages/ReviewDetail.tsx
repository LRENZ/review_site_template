          ...
          <div className="grid lg:grid-cols-[1fr_380px] gap-12 items-start">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-6 text-sm text-muted-foreground">
                ...
                <span className="hidden sm:inline">By DailyChoice Editorial Team</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="grid lg:grid-cols-[1fr_380px] gap-12 relative">
          ...
          <div className="space-y-12">
            ...
            {/* Deep Dive Content (Original Sections) */}
            ...
            <div className="bg-muted/50 p-6 rounded-lg text-sm text-muted-foreground flex gap-4 items-start">
              ...
              <p>
                ...
                <Link href="/disclosure"><a className="underline hover:text-foreground">Read our full ethics statement.</a></Link>
              </p>
            </div>
          </div>
