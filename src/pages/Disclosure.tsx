  ...
  return (
    <Layout>
      <TextPageLayout title="Affiliate Disclosure" subtitle="How we support our independent journalism">
        ...
        <p>
          DailyChoice is an independent publication supported by our readers. When you purchase through links on our site, we may earn an affiliate commission.
        </p>
        <p>
        ...
        <p>
          DailyChoice is a participant in the Amazon Services LLC Associates Program, an affiliate advertising program designed to provide a means for sites to earn advertising fees by advertising and linking to Amazon.com.
        </p>

        <p className="mt-8 text-sm text-muted-foreground italic">
          If you have any questions about our affiliate relationships, please don't hesitate to <a href="/contact" className="underline">contact us</a>.
        </p>
      </TextPageLayout>
    </Layout>
  );
